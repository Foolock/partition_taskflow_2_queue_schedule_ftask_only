...
//      for(const auto& vec : _ready_vectors) {
//        std::cerr << "partition: \n";
//        for(auto pin : vec) {
//          std::cerr << pin->_name << " ";
//        }
//        std::cerr << "\n";
//      }
//      std::cerr << "check pending vectors: \n";
//      for(const auto& vec : _pending_vectors) {
//        std::cerr << "partition: \n";
//        for(auto pin : vec) {
//          std::cerr << pin->_name << " ";
//        }
...
//    tf::Executor _executor{1};
    ...
    std::vector<std::vector<Pin*>> _ready_vectors;
    std::vector<std::vector<Pin*>> _pending_vectors;
